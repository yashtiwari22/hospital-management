...
function ViewPatient() {
    ...
    return (
        <div className="container">
            ...
            <Paper elevation={3} className="patientd3" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <h1 className="text" style={{ color: "white" }}>PATIENT <br />DATA </h1>
