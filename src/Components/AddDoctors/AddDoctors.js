...
const onSubmit= async e=>{
    e.preventDefault();
    await axios.post("http://localhost:9001/Doctors",doctor);
    history.push("/admin");
    console.log(doctor);
}
    return (<>
        ...
        <Paper elevation={3} className="doctor">
            <h1 style={{color:"white"} }className="text6">ADD DOCTOR DATA </h1>
            </Paper>
        </Box>
        ...
        >
            <Paper elevation={3} >
                ...
                <TextField  style={{margin:"20px"}} label="Specialization" variant="outlined"name="specialization" value={specialization} onChange={e=>onInputChange(e)}/>
